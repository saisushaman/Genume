...
async def analyze_resume(file: UploadFile, job_title: str = Form(...)):
    ...
    try:
        ...
        suggestions = run_agents(content, job_title)  # Ensure this matches your agents.py
        
        return {
            "ats_result": ats_result,
            "suggestions": suggestions,
            "fixed_resume_text": suggestions.get("fixed_text", content) if isinstance(suggestions, dict) else content
        }
